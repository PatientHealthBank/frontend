...
export default function QuestionDetailsDialog({ open,setOpen, callBack, question, getQuestionType }) {
                        ...
                        <Grid container className={classes.root} spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <FormControl className={classes.formControl}>
                                  <div>Type:</div> <div><strong>{getQuestionType(question.questionType)}</strong></div>
                                  </FormControl>
                            </Grid>
                            <Grid item xs={6}>
                                <FormControl className={classes.formControl}>
                                <div> Title:</div> <div> <strong>{question.description}</strong></div>
                                </FormControl>
                            </Grid>
