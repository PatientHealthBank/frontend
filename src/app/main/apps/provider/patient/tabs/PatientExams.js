...
import { getPatientTestsResults } from '../../store/patientSlice';
...
function PatientExams(props) {
	...
	const files = useSelector(({ providerApp }) => providerApp.patient.testResults);

    useEffect(() => {
        dispatch(getPatientTestsResults(props.patientId));
    }, [dispatch]);
