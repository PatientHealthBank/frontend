...
const headCells = [
	...
	{ id: 'serviceDate', numeric: false, disablePadding: false, label: 'Service Date' },
	{ id: 'serviceValue', numeric: false, disablePadding: false, label: 'Service Value' },
	{ id: 'registerServiceProvider', numeric: false, disablePadding: false, label: 'Service Provider' },
	{ id: 'fileUrl', numeric: false, disablePadding: false, label: 'File' }
];
...
function InvoicesTable(props) {
	...
	const handleDelete = () => {
		...
		selected.forEach(element => {
			props.DeleteInvoices(rows[element].id, rows[element].fileUrl);
		});
		setSelected([]);
		setSelectedRow({});
