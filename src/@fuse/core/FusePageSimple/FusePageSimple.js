...
const useStyles = makeStyles(theme => ({
	...
	header: {
		...
		//color: theme.palette.pageCardedHeader.contrastText,
...
const FusePageSimple = React.forwardRef((props, ref) => {
	...
	return (
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			...
			<div className="flex flex-auto flex-col z-10 h-full" style={{width: "100%",
			margin: "0 auto",
			maxWidth: props.layout === 1 ? "1620px" : "1420px" }}>
