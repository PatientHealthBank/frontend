...
const calendarDB = {
	events: [
		{
			id: 0,
			title: '08:00 - John Dow',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 2, 8, 0, 0),
			end: setDate(2020, 9, 2, 10, 0, 0),
			patient:'John Due',
		...
		{
			id: 15,
			title: '10:00 - Janet Prince',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 2, 10, 0, 0),
			end: setDate(2020, 9, 2, 12, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		{
			id: 16,
			title: '13:00 - Patric Granwald',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 6, 13, 0, 0),
			end: setDate(2020, 9, 6, 15, 30, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		},
		{
			...
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 6, 8, 0, 0),
			end: setDate(2020, 9, 6, 10, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		},		
		{
			...
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 6, 10, 0, 0),
			end: setDate(2020, 9, 6, 12, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		},
		{
			...
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 7, 13, 0, 0),
			end: setDate(2020, 9, 7, 15, 30, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		},
		{
			...
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 8, 8, 0, 0),
			end: setDate(2020, 9, 8, 10, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		},		
		{
			...
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 8, 10, 0, 0),
			end: setDate(2020, 9, 8, 12, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		},
		{
			...
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 8, 13, 0, 0),
			end: setDate(2020, 9, 8, 15, 30, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		{
			id: 1,
			title: '12:00 - Janet Prince',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 7, 12,0,0),
			end: setDate(2020, 9, 7,14,0,0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		{
			id: 24,
			title: '08:00 - Barbara Dow',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 5, 8, 0, 0),
			end: setDate(2020, 9, 5, 10, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		{
			id: 25,
			title: '10:00 - Erick Prince',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 5, 10, 0, 0),
			end: setDate(2020, 9, 5, 12, 0, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
		...
		{
			id: 26,
			title: '13:00 - Donald Granwald',
			clinic:'Physical Therapist - Clinic 1',
			allDay: false,
			start: setDate(2020, 9, 5, 13, 0, 0),
			end: setDate(2020, 9, 5, 15, 30, 0),
			patient:'John Due',
			email:'john.due@patitienthealth.com',
			ssn:165416541,
			telephone:165416541,
...
mock.onGet('/api/provider-calendar/events').reply(config => {
...
mock.onPost('/api/provider-calendar/update-event').reply(request => {
	const data = JSON.parse(request.data);
...
mock.onPost('/api/provider-calendar/remove-event').reply(request => {
	const data = JSON.parse(request.data);
